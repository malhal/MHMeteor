...
// didChangeObject was upgraded to newer API calls
...
- (void)insertNewObject:(id)sender {
    ...
    [newManagedObject setValue:[UIDevice currentDevice].name forKey:@"text"];
    // Save the context.
    NSError *error = nil;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSNumber* num = [obj valueForKey:@"checked"];
    [obj setValue:[NSNumber numberWithBool:!num.boolValue] forKey:@"checked"];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    if([[object valueForKey:@"checked"] boolValue]){
        cell.accessoryType = UITableViewCellAccessoryCheckmark;
        cell.textLabel.attributedText = [[NSAttributedString alloc] initWithString:(text?text:@"") attributes:@{NSStrikethroughStyleAttributeName : @1}];
    }else{
      ...
      newIndexPath:(NSIndexPath *)newIndexPath
{
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeUpdate:
            ...
            [tableView reloadRowsAtIndexPaths:@[indexPath] withRowAnimation:UITableViewRowAnimationFade]; // change with a fade
            break;
            
        case NSFetchedResultsChangeMove:
            //[tableView deleteRowsAtIndexPaths:@[indexPath] withRowAnimation:UITableViewRowAnimationFade];
            //[tableView insertRowsAtIndexPaths:@[newIndexPath] withRowAnimation:UITableViewRowAnimationFade];
            [tableView moveRowAtIndexPath:indexPath toIndexPath:newIndexPath]; // newer API
            break;
    }
}
